...
const page = () => {
  return (
    <div className="pt-[6.8rem]">
      ...
      <div className="bg-[#F5F8FB] padding-x py-[55px] flex items-center gap-5 ">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm font-light text-[#898A9C]">
            Home <span>/</span> <span>Offshore License</span>
          </p>
        </div>
      </div>
      ...
      <div className="padding-x py-[7.5rem] flex flex-col justify-between items-center gap-6 w-full">
        ...
        <div className="flex-1">
          <div className="flex flex-col gap-4 mt-4">
            ...
            <p className=" text-[#898A9C] text-[15px] font-light">
              ...
              wealth management, asset protection, and the application of smart
              international investment strategies, offering ease and freedom in
              business operations without the burdensome regulations often found
              in other jurisdictions.
            </p>
            <p className=" text-[#898A9C] text-[15px] font-light">
              Offshore companies in the UAE are registered within the country’s
              legal framework but are permitted to operate outside the Emirate,
              granting them flexibility in terms of business conduct and asset
              movement. This setup is particularly advantageous for businesses
              that do not require a physical presence in the UAE but wish to
              benefit from the country’s favorable business climate. Dubai
              offshore company formation can take various forms, including
              limited liability companies (LLCs), limited companies, and limited
              partnerships, each catering to different business needs and
              strategic goals.
            </p>
          </div>
        </div>
