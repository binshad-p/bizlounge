...
const EasyConnect = () => {
  return (
    <div className="p-10 bg-primary rounded-md text-white flex justify-between">
      <p className="flex flex-col  font-light text-[40px]">
        Let’s make it easy
        <span className="font-semibold"> connect with us quickly!</span>{" "}
      </p>
      <div className="grid grid-cols-3 gap-5">
        <div className="flex flex-col justify-center items-center gap-3  border-r-2 border-dashed border-white pr-5">
          <PhoneCall size={40}/>
